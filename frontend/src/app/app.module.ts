...
import { BaseColorComponent } from './color/base-color/base-color.component';
import { DscColorSettingComponent } from './color/dsc-color-setting/dsc-color-setting.component';
import { DscButtonSettingComponent } from './button/dsc-button-setting/dsc-button-setting.component';
...
import { DemoButtonComponent } from './button/demo-button/demo-button.component';
